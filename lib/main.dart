...
class PortfolioApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'T. Sri Amshu Kumar - Portfolio',
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Roll No: 24XV1M7619 • Computer Science & Engineering',
                textAlign: TextAlign.center,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20),
                  const Text(
                    "Hello! I'm T. Sri Amshu Kumar (Roll No: 24XV1M7619). "
                    "I am passionate about software engineering, data structures, and building robust, scalable applications.",
                    textAlign: TextAlign.center,
                  ...
                  Wrap(
                    ...
                    children: const [
                      ...
                      SkillChip(label: 'C / C++'),
                      SkillChip(label: 'Algorithms & Data Structures'),
            ...
            child: Column(
              ...
              children: [
                const ProjectCard(
                  ...
                  description:
                      'A cross-platform web portfolio built in Flutter, automated with GitHub Actions, and hosted on GitHub Pages.',
                ),
                const SizedBox(height: 16),
                const ProjectCard(
                  title: 'Core Algorithm Visualizer',
                  description:
                      'Implementations of key computer science algorithms focusing on graph traversal, dynamic programming, and optimization techniques.',
                ),
                const SizedBox(height: 28),
                ElevatedButton(
                  onPressed: () => Navigator.pop(context),
